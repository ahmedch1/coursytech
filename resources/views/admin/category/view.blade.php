                  ...
                  <form id="demo-form2" method="post" action="{{url('category/')}}" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input placeholder="Enter category name" type="text" class="form-control" name="title" required="">
                      </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input pattern="[/^\S*$/]+" placeholder="Enter slug" type="text" class="form-control" name="slug" required >
                      </div>
                    </div>
                    <br>
