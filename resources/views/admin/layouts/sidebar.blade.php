        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isResource('user/course/report') }} {{ Nav::isResource('user/question/report') }} treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isResource('admin/report/view') }}"><a href="{{url('admin/report/view')}}"><i class="flaticon-error"></i><span>{{ __('adminstaticword.Report') }} Course</span></a></li>
          ...
          <li class="{{ Nav::isRoute('admin.revenue.report') }} {{ Nav::isRoute('instructor.revenue.report') }} treeview">
           <a href="#">
             <i class="flaticon-faq" aria-hidden="true"></i> <span>{{ __('adminstaticword.Report') }}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
          ...
          <li class="{{ Nav::isRoute('import.view') }} {{ Nav::isRoute('database.backup') }} {{ Nav::isRoute('update.process') }} {{ Nav::isRoute('quick.update') }} treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ Nav::isRoute('remove.public') }}"><a href="{{route('remove.public')}}" title="Remove Public"><span><i class="fa fa-comment-o" aria-hidden="true"></i>&emsp; {{ __('adminstaticword.RemovePublic') }}</span></a></li>
